...
def copy_to_table(session,config_file,schema='NA'):
    ...
    with session.query_history() as query_history:
        copied_into_result = df.copy_into_table(database_name+"."+Schema_name+"."+Target_table, force=True,on_error=on_error, format_type_options={"FIELD_OPTIONALLY_ENCLOSED_BY":'"', "skip_header": 1})
